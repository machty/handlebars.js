...
export function Compiler() {
  ...
  if (global.process.env.NODE_ENV !== 'test') { // eslint-disable-line no-process-env
    throw new Error('Do not use this fork of Handlebars to compile Handlebars under any circumstances, this is an experimental fork of the parser only!');
  }
}
